      ...
      <div className='flex max-lg:flex-col-reverse relative' >
        <div className='hero-left relative z-50 max-lg:mb-[40px]'>
          ...
          <div className='flex cta flex-wrap gap-[8px]' >
            <a href="http://liquidus.app.link/dsmexkJD1tb" target={'_blank'} className=' btn-1 items-center'>
            ...
            <a href="https://apps.apple.com/pk/app/liquidus-defi-crypto-wallet/id1625544806" target={'_blank'} className='btn-1 items-end'>
            ...
            <a href="https://play.google.com/store/apps/details?id=finance.liquidus.wallet&pli=1" target={'_blank'} className='btn-1 items-end'>
