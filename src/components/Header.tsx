      ...
      <div className='w-full max-md:hidden' >
        <div className='flex justify-end items-center ' >
          ...
          <div className='header-upper ml-[30px]' >
            <a className=' opacity-50 op transition-opacity hover:opacity-100 mr-[30px]' href="#">CoinGecko</a>
            <a className=' opacity-50 transition-opacity hover:opacity-100' href="#">CMC</a>
          </div>
        </div>
